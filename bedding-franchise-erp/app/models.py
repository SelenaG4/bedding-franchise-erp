...
class Account(Base):
    ...
    retail arm, its own online-fulfillment warehouse, or (for individual
    walk-in/direct sales, which aren't tracked per-person in this system) a
    single shared account per location."""
